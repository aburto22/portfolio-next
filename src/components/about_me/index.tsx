...
import TextContainer from '@components/about_me/text_container';
...
const AboutMe = () => (
  <>
    ...
    <styles.Section>
      ...
      <TextContainer heading="Studies" anchor="studies">
        <Text>
      ...
      <TextContainer heading="Work experience" anchor="work">
        <Text>
      ...
      <TextContainer heading="Some time off" anchor="time-off">
        <Text>
      ...
      <TextContainer heading="My coding journey" anchor="coding">
        <Text>
      ...
      <TextContainer heading="What about now?" anchor="now">
        <Text>
      ...
      <TextContainer heading="Apart from coding" anchor="apart">
        <Text>
